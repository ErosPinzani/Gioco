...
#include "../../Include/Characters/Melee.h"

Melee::Melee(const TextureHolder& textures, sf::Vector2u windowSize):textures(textures), counterWalk(0), delayWalk(false), delayMoreWalk(false), shooting(false), dead(false) {
    heroType = close;
