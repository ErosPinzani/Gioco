...
#include "../../Include/Characters/StRanged.h"

stRanged::stRanged(const TextureHolder& textures, sf::Vector2u windowSize):textures(textures), counterWalk(0), delayWalk(false), delayMoreWalk(false), shooting(false), dead(false) {
    heroType = St;
